...
NOTE : when running script with -s3 option for polarity evaluation, the result might differ from the results obtained with official semeval script (this is related to the way one treats gold aspect/term annotations). 
