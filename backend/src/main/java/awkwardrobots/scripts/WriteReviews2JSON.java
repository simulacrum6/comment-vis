...
public class WriteReviews2JSON {

	public static void main(String[] args) throws Exception {
		// transform to opinions
		List<Comment> comments = DatasetLoader.loadComments(DatasetLoader.REVIEWS);
		...
		// save to file
		new ObjectMapper().writeValue(new File("src/main/resources/data/kotzias2015/reviews.ce.json"), opinions);
	}
